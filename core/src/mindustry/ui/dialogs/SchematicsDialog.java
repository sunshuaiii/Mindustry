            ...
            rebuildPane = () -> {
                ...
                for(Schematic s : schematics.all()){
                    ...
                    sel[0] = t.button(b -> {
                        ...
                        }).visible(() -> state.is(State.menu) || !(state.rules.infiniteResources || (player.getClosestCore() != null && 
                            player.getClosestCore().items.has(s.requirements().toArray(ItemStack.class), state.rules.buildCostMultiplier))))).size(200f);
                    }, () -> {
